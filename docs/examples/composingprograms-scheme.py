"""This module implements the core Scheme interpreter functions, including the eval/apply mutual recurrence, environment model, and read-eval-print loop.

  src http://inst.eecs.berkeley.edu/~cs61a/fa13/proj/scheme/scheme.html
"""
